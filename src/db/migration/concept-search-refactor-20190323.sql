 ...
 *      app.sp_GetConceptHintsBySearchTerms
 *      app.sp_GetConceptsBySearchTerms
 *
 *  removed:
 *      app.sp_GetConceptHintsBySearchTerm
 *      app.sp_GetLimitedConceptHintsBySearchTerm
 *
 *  added:
 *      app.ConceptTokenizedIndex
 */
...
------------------------------------------------------------------
DROP PROCEDURE app.sp_GetConceptHintsBySearchTerm

------------------------------------------------------------------
DROP PROCEDURE app.sp_GetLimitedConceptHintsBySearchTerm

------------------------------------------------------------------
/****** Object:  StoredProcedure [app].[sp_UpdateSearchIndexTables]    Script Date: 3/23/2019 6:18:54 PM ******/
SET ANSI_NULLS ON
GO
...
------------------------------------------------------------------
/****** Object:  StoredProcedure [app].[sp_GetConceptHintsBySearchTerms]    Script Date: 3/23/2019 6:19:28 PM ******/
SET ANSI_NULLS ON
GO
...
------------------------------------------------------------------
/****** Object:  StoredProcedure [app].[sp_GetConceptsBySearchTerms]    Script Date: 3/23/2019 6:20:37 PM ******/
SET ANSI_NULLS ON
GO
