...
import { handleRespondentToggle } from '../../../actions/networkRespondents';
import GlowingButton, { GLOWING_BUTTON_STATE } from '../../../components/Other/GlowingButton/GlowingButton';
...
import './NetworkHealthRespondent.css';
...
interface Props {
    ...
    totalActiveRespondents: number;
}

export default class NetworkHealthRespondent extends React.Component<Props> {
    private className = 'header-networkhealth-respondent';
    ...
    private handleClick = () => {
        const { allowDisable, totalActiveRespondents, identity, queryState, dispatch } = this.props;
        ...
        if (totalActiveRespondents === 1 && identity.enabled) {
        ...
        // Else good to go
            ...
            this.props.dispatch(handleRespondentToggle(identity));
        }
    }
}
