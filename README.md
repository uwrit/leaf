...
**Leaf** is a powerful, fun, lightweight web application for querying clinical data. Leaf helps query clinical databases of nearly any data model for cohort estimation and data extraction. Leaf is designed to seamlessly integrate with clinical databases and enterprise authentication systems to further unleash the potential of translational biomedical research.
